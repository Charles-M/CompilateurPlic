...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun May 18 16:31:32 CEST 2014
  */
  ...
  public final java_cup.runtime.Symbol CUP$AnalyseurSyntaxique$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$AnalyseurSyntaxique$act_num)
		...
		int iright = ((java_cup.runtime.Symbol)CUP$AnalyseurSyntaxique$stack.peek()).right;
		String i = (String)((java_cup.runtime.Symbol) CUP$AnalyseurSyntaxique$stack.peek()).value;
 tds.ajouter(new Entree(i, ileft+1, "fonction"), t) ; lexique.ajouterBloc(new Function(i, t)) ; tds.entreeBloc() ; bloc_courant++ ; 
		...
		ArrayList<Entree> l = (ArrayList<Entree>)((java_cup.runtime.Symbol) CUP$AnalyseurSyntaxique$stack.elementAt(CUP$AnalyseurSyntaxique$top-1)).value;
		 System.out.println("in decl_var type="+t+" idf="+i+" liste="+l) ;
                       lexique.ajouterDecl(bloc_courant, new D_Var(i,ileft+1,t)) ;
                       tds.ajouter(new Entree(i, ileft+1, "variable"), t) ;
                       for(Entree idf : l) {
                        idf.setEspace("variable") ;
                        lexique.ajouterDecl(bloc_courant, new D_Var(idf.getNom(),idf.getLine(),t)) ;
                        tds.ajouter(idf, t) ;
                       } 
		...
		int iright = ((java_cup.runtime.Symbol)CUP$AnalyseurSyntaxique$stack.peek()).right;
		String i = (String)((java_cup.runtime.Symbol) CUP$AnalyseurSyntaxique$stack.peek()).value;
 tds.ajouter(new Entree(i, ileft+1, "fonction"), i) ; lexique.ajouterBloc(new Function(i, i)) ; tds.entreeBloc() ; bloc_courant++ ; 
		...
		int iright = ((java_cup.runtime.Symbol)CUP$AnalyseurSyntaxique$stack.peek()).right;
		String i = (String)((java_cup.runtime.Symbol) CUP$AnalyseurSyntaxique$stack.peek()).value;
 System.out.println("(entree bloc)") ; lexique.ajouterBloc(new Classe(i)) ; tds.entreeBloc() ; bloc_courant++ ; 
